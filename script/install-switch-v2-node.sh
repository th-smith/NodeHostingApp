...
# Prepare the password for sending
set prepared_password [subst -nobackslashes -nocommands -novariables {$password}]
send -- "\$prepared_password\r"
...
#Download locations
date=$(date +%s)
domain="download.switchrewardcard.com"
